...
APP_NAME="grit"
APP_VERSION="0.1.0-alpha.1743007075"
ARTIFACT_DOWNLOAD_URL="${INSTALLER_DOWNLOAD_URL:-https://github.com/getgrit/gritql/releases/download/v0.1.0-alpha.1743007075}"
PRINT_VERBOSE=${INSTALLER_PRINT_VERBOSE:-0}
PRINT_QUIET=${INSTALLER_PRINT_QUIET:-0}
NO_MODIFY_PATH=${INSTALLER_NO_MODIFY_PATH:-0}
read -r RECEIPT <<EORECEIPT
{"binaries":["CARGO_DIST_BINS"],"binary_aliases":{},"cdylibs":["CARGO_DIST_DYLIBS"],"cstaticlibs":["CARGO_DIST_STATICLIBS"],"install_prefix":"AXO_INSTALL_PREFIX","provider":{"source":"cargo-dist","version":"0.22.0"},"source":{"app_name":"grit","name":"gritql","owner":"getgrit","release_type":"github"},"version":"0.1.0-alpha.1743007075"}
EORECEIPT
...
The installer for grit 0.1.0-alpha.1743007075

This script detects what platform you're on and fetches an appropriate archive from
https://github.com/getgrit/gritql/releases/download/v0.1.0-alpha.1743007075
